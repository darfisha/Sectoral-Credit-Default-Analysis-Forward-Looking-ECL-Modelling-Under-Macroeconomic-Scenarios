...
# ------------------------
    ...
    with st.form("input_form"):
        ...
        principal = st.number_input("Original Principal Amount (USD)", 0.0, 1e7, 100000.0)
        cancelled = st.number_input("Cancelled Amount (USD)", 0.0, 1e7, 0.0)
        undisbursed = st.number_input("Undisbursed Amount (USD)", 0.0, 1e7, 0.0)
        disbursed = st.number_input("Disbursed Amount (USD)", 0.0, 1e7, 50000.0)
        repaid = st.number_input("Repaid to IBRD (USD)", 0.0, 1e7, 20000.0)
        due = st.number_input("Due to IBRD (USD)", 0.0, 1e7, 10000.0)
